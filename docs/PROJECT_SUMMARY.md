...
已加入 `.github/workflows/release.yml`。许可问题解决后，推送与 `manifest.json` 版本一致的标签（例如 `0.2.7`）会生成 BRAT 需要的 release assets：`main.js`、`manifest.json`、`styles.css`、`versions.json`。
